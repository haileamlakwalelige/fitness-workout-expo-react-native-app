  ...
  return (
    <SafeAreaView>
      <View className="bg-white h-screen justify-start p-5">
        ...
        <Text className="text-gray-700 pb-2 px-1">Email Address</Text>
        <TextInput
        ...
        />
        <Text className="text-gray-700 pb-2 px-1 mt-6">Passwod</Text>
        <TextInput
        ...
        <View className="flex-col justify-start items-start mt-6">
          <View className="flex-row justify-center items-center w-full mt-6">
            ...
            <Link href="/auth/regsiter" asChild>
              <Text className="text-black ml-1 font-bold">Create Account</Text>
            </Link>
          </View>
